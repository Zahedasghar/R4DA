---
title: "[Data Taxonomy in Action: Applied Econometrics Workshop]{.flow}"
subtitle: "[]{style=color:red;}"
author: "[ZAHID ASGHAR, School of Economics, QAU]{.adage}"
format:
  revealjs:
    logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQS4LpKlKT6YYCdOLCJFo-GQLBedqSJK8knGw&s"
...
```{r fig.align='center'}
knitr::include_graphics("images/shoebill-1.png")
```

------------------------------------------------------------------------

```{r fig.align='center'}
knitr::include_graphics("images/Stat 20 Sketches For Slides-5.jpg")
```
...
::: {.column width="50%"}
```{r fig.align='center'}
knitr::include_graphics("images/plant-taxonomy.jpeg")
```
:::
...
```{r}
knitr::include_graphics("images/taxonomy-of-data.png")
```
...
```{r out.width = "60%"}
knitr::include_graphics("images/palmer-station.jpeg")
```
...
```{r}
knitr::include_graphics("images/non-tidy-contingency-table.png")
```
...
```{r}
knitr::include_graphics("images/non-tidy-world-bank.png")
```
